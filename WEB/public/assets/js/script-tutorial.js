...
function typeWriter() {
    ...
    // Ocultar los botones de navegación durante la escritura
    ...
    function type() {
        if (i < currentText.length) {
            ...
            // Mostrar los botones de navegación después de escribir
            if (currentTextIndex === animationTexts.length - 1) {
...
// Función nextText para mostrar el siguiente texto
function nextText() {
...
// Función prevText para mostrar el texto anterior
function prevText() {
